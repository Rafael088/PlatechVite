    ...
    return ( 
        <section className="contServices" id="services" >
            <div className="contBody">
                <Cards id="one" text="Transformacion Digital" title="Falcon" img="https://cdn.discordapp.com/attachments/1065066497300504661/1067267988052529172/browser.png"/>
                <Cards id="two" text="Gestión de productividad y Automatizaciones" title="Aplicaciones" img="https://cdn.discordapp.com/attachments/1065066497300504661/1067264782991888504/574117322.png"/>
